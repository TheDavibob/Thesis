function [Y] = Y_Continuous_Scattering_Nov2018_Mod(x2,k1,k3,omega,U,c,delta,N_bl)
%The x2 dependent part, i.e. just phid. This is easy!

% This modification truncates for very very small values, as machine error
% is aggressively creeping in.
