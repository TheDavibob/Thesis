function [f] = ODEFun_PB_Aug18A_GridX(x2,Phi_jm1,k1,omega,c,U,k3)
...
% Updated to allow variable griddy input thingies, pretty much just
% allowing vector as opposed to scalar x2 and changing bugger all.
